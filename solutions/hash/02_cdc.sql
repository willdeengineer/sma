...
-------------------------------------------------
--- Snowflake CDC proces op basis van hashing
--- Stappen:
--- 1. Detecteren rijen waar niets is gewijzigd
--- 2️. Duplicate insert in staging detecteren
--- 3️. Insert naar TARGET_ENTITY
--- 4️. Duplicate update in staging detecteren
--- 5️. Oude actieve versie afsluiten (bij updates)
--- 6️. Geupdate versie toevoegen
--- 7️. Soft delete
--- 8️. Run loggen
